  ...
  const projects = [
    {
      ...
      description:
        "Contributed to the development and scaling of the HCL Design System, a centralized enterprise-grade UI framework aimed at unifying visual language across dozens of internal and external digital products. The design system improved design consistency, reduced development overhead, and accelerated product delivery timelines for HCL and its clients.",
      contributions: [
      ...
      techStack:
        "Angular, Vanilla JS, TypeScript, SCSS, Storybook, Figma, AWS (S3, EC2, CloudFront), GitHub Actions",
      link: "https://www.hcltech.com/case-study/design-system-development-and-implementation",
    },
    {
      title: "Olive Gaea",
      role: "Full Stack Developer",
      description:
        "Worked on Olive Gaea's climate-tech platform to enable individuals and enterprises to track, reduce, and offset carbon emissions seamlessly.",
      contributions: [
      ...
      link: "https://www.olivegaea.com/",
    },
    {
      title: "LOWES",
      role: "Software Engineer",
      description:
        "Enhanced frontend systems for Lowe's U.S. e-commerce platform to improve digital retail experiences across web and mobile.",
      contributions: [
    ...
    },
    {
      ...
      description:
        "Improved user-facing features on Blackboard Learn LMS used by K–12 and higher education institutions globally.",
      contributions: [
      ...
      link: "https://www.blackboard.com/en-apac/teaching-learning/learning-management/mobile-learning-solutions",
    },
    {
      title: "JANUS",
      role: "Automation Engineer",
      description:
        "Designed Playwright-based automation pipelines for processing insurance authorization requests via EDI 278I/278R standards.",
      contributions: [
      ...
      link: "https://app.janus-ai.com/",
    },
    {
      title: "Bryte Smart Beds",
      role: "Backend Developer",
      description:
        "Developed backend systems for Bryte's AI-powered smart bed technology designed to optimize sleep through biometric sensing and real-time adjustments.",
      contributions: [
    ...
    },
    {
      ...
      description:
        "Developed data transformation flows using IBM ITX (WTX) for large-scale B2B/EDI processing in healthcare/finance industries.",
      contributions: [
        "Designed reusable EDI mappings (X12 standards like 837/835).",
        "Ensured HIPAA/PCI compliance for sensitive data flows.",
      ],
      techStack: "IBM ITX, EDI X12, Financial Data Standards",
    },
    {
      title: "Estée Lauder",
      role: "Mainframe Developer",
      description:
        "Enhanced global brand websites like MAC Cosmetics and Clinique by improving user engagement and campaign velocity.",
      contributions: [
        ...
        {projects.map((project, index) => (
          <div className="portfolio-item" key={index}>
            ...
            {project.link && (
              ...
              >{`Learn more about ${project.title}`}</a>
            )}
          </div>
        ))}
      </div>
